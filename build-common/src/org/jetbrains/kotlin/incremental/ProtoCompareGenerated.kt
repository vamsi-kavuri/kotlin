...
open class ProtoCompareGenerated(val oldNameResolver: NameResolver, val newNameResolver: NameResolver) {
    ...
    open fun checkEquals(old: ProtoBuf.Package, new: ProtoBuf.Package): Boolean {
        ...
        if (old.hasRequireLanguageVersionTable() != new.hasRequireLanguageVersionTable()) return false
        if (old.hasRequireLanguageVersionTable()) {
            if (!checkEquals(old.requireLanguageVersionTable, new.requireLanguageVersionTable)) return false
        }
    ...
    enum class ProtoBufPackageKind {
        ...
        TYPE_ALIAS_LIST,
        TYPE_TABLE,
        REQUIRE_LANGUAGE_VERSION_TABLE,
    ...
    fun difference(old: ProtoBuf.Package, new: ProtoBuf.Package): EnumSet<ProtoBufPackageKind> {
        ...
        if (old.hasRequireLanguageVersionTable() != new.hasRequireLanguageVersionTable()) result.add(ProtoBufPackageKind.REQUIRE_LANGUAGE_VERSION_TABLE)
        if (old.hasRequireLanguageVersionTable()) {
            if (!checkEquals(old.requireLanguageVersionTable, new.requireLanguageVersionTable)) result.add(ProtoBufPackageKind.REQUIRE_LANGUAGE_VERSION_TABLE)
        }
    ...
    open fun checkEquals(old: ProtoBuf.Class, new: ProtoBuf.Class): Boolean {
        ...
        if (old.hasRequireLanguageVersion() != new.hasRequireLanguageVersion()) return false
        if (old.hasRequireLanguageVersion()) {
            if (old.requireLanguageVersion != new.requireLanguageVersion) return false
        }
    ...
    fun difference(old: ProtoBuf.Class, new: ProtoBuf.Class): EnumSet<ProtoBufClassKind> {
        ...
        if (old.hasRequireLanguageVersion() != new.hasRequireLanguageVersion()) result.add(ProtoBufClassKind.REQUIRE_LANGUAGE_VERSION)
        if (old.hasRequireLanguageVersion()) {
            if (old.requireLanguageVersion != new.requireLanguageVersion) result.add(ProtoBufClassKind.REQUIRE_LANGUAGE_VERSION)
        }

        if (old.hasRequireLanguageVersionTable() != new.hasRequireLanguageVersionTable()) result.add(ProtoBufClassKind.REQUIRE_LANGUAGE_VERSION_TABLE)
        if (old.hasRequireLanguageVersionTable()) {
            if (!checkEquals(old.requireLanguageVersionTable, new.requireLanguageVersionTable)) result.add(ProtoBufClassKind.REQUIRE_LANGUAGE_VERSION_TABLE)
        }
    ...
    open fun checkEquals(old: ProtoBuf.RequireLanguageVersionTable, new: ProtoBuf.RequireLanguageVersionTable): Boolean {
        if (!checkEqualsRequireLanguageVersionTableRequirement(old, new)) return false
    ...
    open fun checkEquals(old: ProtoBuf.RequireLanguageVersion, new: ProtoBuf.RequireLanguageVersion): Boolean {
    ...
    open fun checkEqualsRequireLanguageVersionTableRequirement(old: ProtoBuf.RequireLanguageVersionTable, new: ProtoBuf.RequireLanguageVersionTable): Boolean {
...
fun ProtoBuf.Package.hashCode(stringIndexes: (Int) -> Int, fqNameIndexes: (Int) -> Int): Int {
    ...
    if (hasRequireLanguageVersionTable()) {
        hashCode = 31 * hashCode + requireLanguageVersionTable.hashCode(stringIndexes, fqNameIndexes)
    }
...
fun ProtoBuf.Class.hashCode(stringIndexes: (Int) -> Int, fqNameIndexes: (Int) -> Int): Int {
    ...
    if (hasRequireLanguageVersion()) {
        hashCode = 31 * hashCode + requireLanguageVersion
    }
...
fun ProtoBuf.RequireLanguageVersionTable.hashCode(stringIndexes: (Int) -> Int, fqNameIndexes: (Int) -> Int): Int {
    var hashCode = 1
...
fun ProtoBuf.RequireLanguageVersion.hashCode(stringIndexes: (Int) -> Int, fqNameIndexes: (Int) -> Int): Int {
    var hashCode = 1
