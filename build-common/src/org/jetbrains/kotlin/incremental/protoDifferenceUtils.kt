    ...
    override fun difference(): Difference {
        ...
        for (kind in diff) {
            ...
            val unused: Any = when (kind!!) {
                ...
                ProtoCompareGenerated.ProtoBufClassKind.REQUIRE_LANGUAGE_VERSION,
                ProtoCompareGenerated.ProtoBufClassKind.REQUIRE_LANGUAGE_VERSION_TABLE -> {
                    // TODO
                }
    ...
    override fun difference(): Difference {
        ...
        for (kind in diff) {
            ...
            val unused: Any = when (kind!!) {
                ...
                ProtoBufPackageKind.REQUIRE_LANGUAGE_VERSION_TABLE,
