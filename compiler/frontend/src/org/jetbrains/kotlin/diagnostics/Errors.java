...
public interface Errors {
    ...
    DiagnosticFactory3<PsiElement, DeclarationDescriptor, RequireLanguageVersion.Version, Pair<LanguageVersion, String>>
            REQUIRE_LANGUAGE_VERSION_DEPRECATION = DiagnosticFactory3.create(WARNING);
    DiagnosticFactory3<PsiElement, DeclarationDescriptor, RequireLanguageVersion.Version, Pair<LanguageVersion, String>>
            REQUIRE_LANGUAGE_VERSION_DEPRECATION_ERROR = DiagnosticFactory3.create(ERROR);
