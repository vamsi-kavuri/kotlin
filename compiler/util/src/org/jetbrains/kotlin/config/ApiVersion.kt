...
class ApiVersion private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun createByRequireLanguageVersion(requireLanguageVersion: RequireLanguageVersion): ApiVersion =
                requireLanguageVersion.version.let { version -> parse(version.asString()) ?: error("Could not parse version: $version") }
