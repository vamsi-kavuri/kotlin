...
interface DeserializedMemberDescriptor : MemberDescriptor {
    ...
    val requireLanguageVersionTable: RequireLanguageVersionTable

    val requireLanguageVersion: RequireLanguageVersion?
        get() = RequireLanguageVersion.create(proto, nameResolver, requireLanguageVersionTable)
...
class DeserializedSimpleFunctionDescriptor(
        ...
        override val requireLanguageVersionTable: RequireLanguageVersionTable,
    ...
    override fun createSubstitutedCopy(
        ...
        return DeserializedSimpleFunctionDescriptor(
                ...
                proto, nameResolver, typeTable, requireLanguageVersionTable, containerSource, source
        )
    }
}
...
class DeserializedPropertyDescriptor(
    ...
    override fun createSubstitutedCopy(
        ...
        return DeserializedPropertyDescriptor(
                ...
                @Suppress("DEPRECATION") isDelegated, isExpect, proto, nameResolver, typeTable, requireLanguageVersionTable, containerSource
        )
    }
