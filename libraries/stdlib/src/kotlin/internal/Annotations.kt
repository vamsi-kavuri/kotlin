 ...
 *
 * This annotation is erased at compile time; its arguments are stored in a more compact form in Kotlin metadata.
 */
...
internal annotation class RequireLanguageVersion(
        val version: String,
        val message: String = "",
